...
// Shout out to AlMarDev_ on Reddit for customized avatar source:
// https://www.reddit.com/r/PixelArt/comments/1c37fpq/free_set_of_16x16_rpg_icons_info_on_comments/
public class Tileset {
    public static final TETile AVATAR = new TETile('@', Color.white, Color.black, "you", 0);
    public static final TETile AVATAR_BERRY = new TETile('@', Color.white, Color.black,
            "you berry", "src/berry.png", 13);
    public static final TETile AVATAR_MEAT = new TETile('@', Color.white, Color.black,
            "you meat", "src/meat.png",14);
    public static final TETile AVATAR_SWORD = new TETile('@', Color.white, Color.black,
            "you sword", "src/sword.png",15);
